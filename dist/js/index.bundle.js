...
/***/ "./src/js/gallery-thumbs/gallery-thumbs.js":
/*!*************************************************!*\
  !*** ./src/js/gallery-thumbs/gallery-thumbs.js ***!
  \*************************************************/
        ...
        if (attr) {
          if (clickedElem.hasAttribute(attr) && clickedElem.getAttribute(attr) !== "") {
            if (!originPath) {
              ...
              clonedMediaItem.setAttribute(attr, (0,_helpers_funcsDOM_js__WEBPACK_IMPORTED_MODULE_0__.replaceFilePath)(clickedElem.getAttribute(attr), originPath));
            }
          } else {
...
/* harmony import */ var _gallery_thumbs_gallery_thumbs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gallery-thumbs/gallery-thumbs.js */ "./src/js/gallery-thumbs/gallery-thumbs.js");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  }).then(() => (0,_gallery_thumbs_gallery_thumbs_js__WEBPACK_IMPORTED_MODULE_2__.initThumbs)("#gallery-work", "assets/img/gallery")).catch(error => {
    console.error(error);
  });
