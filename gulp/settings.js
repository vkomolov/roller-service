...
const headParams = {
    index: {
        description: "[Терміновий ремонт та встановленння ролетних систем, воріт,  маркізів, шлагбаумів, відеопостереження в Київі та Київській області] $ Краща ціна ➤ Оперативна робота професійного персоналу  ➨ Заходьте!",
        robots: "noindex",
